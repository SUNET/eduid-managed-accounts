  ...
  return (
    <>
      ...
      <section>
        ...
        <p>Add every student in this form, to create their username and password.</p>
        {showMore ? (
          <button
            type="button"
          ...
          >
            <FormattedMessage defaultMessage="READ MORE" id="addToGroup-showList" />
          </button>
        ) : (
          <>
            <button
              ...
              onClick={toggleShowMore}
            >
              <FormattedMessage defaultMessage="READ LESS" id="addToGroup-hideList" />
            </button>
